...
public class Solution {
    ...
    private TreeNode buildTree(int[] preorder, int[] inorder, int preIndex, int inStart, int inEnd) {
        ...
        root.left = buildTree(preorder, inorder, preIndex + 1, inStart, rootIndex - 1);
        root.right = buildTree(preorder, inorder, preIndex + rootIndex - inStart + 1, rootIndex + 1, inEnd);
