...
class ShortestPath {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> ans = shortestPath(n, graph, source, destination);
        for (int node : ans) {
            System.out.println(node);
        }
    }

    public static List<Integer> shortestPath(int n, ArrayList<ArrayList<Integer>> graph, int source, int destination) {
