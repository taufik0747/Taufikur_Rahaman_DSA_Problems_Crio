...
public class Solution{
    ...
    public Node copyRandomList(Node head) {
        ...
        // First pass: Create a copy of each node without random pointers and map them
        Node current = head;
        while (current != null) {
        ...
        // Second pass: Set the random pointers of the copied nodes based on the mapping
        current = head;
        while (current != null) {
